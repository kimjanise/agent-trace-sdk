...
def python_to_json_schema(python_type : Any) -> dict:
    if python_type in PYTHON_TO_JSON_TYPE:
        return {python_type : PYTHON_TO_JSON_TYPE[python_type]}
...
def generate_tool_schema(func: Callabe) -> dict:
...
class ToolWrapper:
    def __init__(self, func: Callable, name: str = None, description: str = None):
        ...
        self._isasync = asyncio.iscoroutinefunction(func)
